...
export function buildGlwGenesisModuleManifest(): GenesisModuleManifest {
  return {
    ...
    navigation: [
      ...
      { label: "Delivery Operations", href: "/glw/delivery-operations", icon: "queue", order: 31, enabled: true },
    ...
    routes: [
      ...
      { label: "Delivery Operations", href: "/glw/delivery-operations", description: "Callback delivery escalation and audited recovery" },
