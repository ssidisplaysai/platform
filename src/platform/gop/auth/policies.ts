...
export const genesisDefaultPolicies: GenesisPolicy[] = [
  ...
  {
    policyId: "delivery-recovery-approval",
    description: "Managers and administrators may approve another actor's delivery recovery request.",
    effect: "allow",
    roles: ["MANAGER", "ADMINISTRATOR"],
    moduleIds: ["glw.delivery"],
    actions: [
      "glw:delivery:view",
      "glw:delivery:recovery:approve",
    ],
  },
  {
    ...
    actions: [
      ...
      "job:open_result",
      "glw:delivery:view",
      "glw:delivery:metrics:view",
      "glw:delivery:reconciliation:view",
      "glw:delivery:reconciliation:run",
      "glw:delivery:escalation:acknowledge",
      "glw:delivery:escalation:assign",
      "glw:delivery:escalation:close",
      "glw:delivery:comment",
      "glw:delivery:recovery:request",
      "gmp:project:view",
      "gmp:project:manage",
      "gmp:knowledge:view",
