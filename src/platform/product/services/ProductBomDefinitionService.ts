    ...
    try {
      ...
      if (error instanceof ProductError && error.code === "INVARIANT_VIOLATION") {
        ...
        await this.audit.append({
          eventType: "PRODUCT_BOM_DEFINITION_REJECTED",
          tenantId: input.tenantId,
          productId: input.productId,
          actor: input.actor,
          message: "BOM definition rejected due to invariant violation",
          details: {
            billOfMaterialDefinitionId: input.billOfMaterialDefinitionId,
