...
export type ManufacturingFailureClassification =
  ...
  | "PERSISTENCE_READ_FAILURE"
  | "PERSISTENCE_ATOMIC_REPLACE_FAILURE"
  | "PERSISTED_STATE_CORRUPT"
  | "UNSUPPORTED_PERSISTENCE_SCHEMA"
  | "INVALID_PERSISTED_MANIFEST"
  | "PERSISTED_TENANT_MISMATCH"
  | "RECOVERY_INVARIANT_FAILURE"
  | "RECOVERY_ROUTING_FAILURE"
  | "RECOVERY_TRACEABILITY_FAILURE"
  | "RECOVERY_IDEMPOTENCY_FAILURE"
  | "RECOVERY_VERSION_FAILURE"
