      ...
      <div className="p-5 sm:p-6">
        ...
        {step === 5 && assessment && site ? (
          <div className="space-y-6">
            ...
            <section className="border border-red-900 bg-red-950/20 p-5"><h3 className="font-semibold text-white">Establish strategy before generation</h3><p className="mt-2 text-sm text-zinc-300">Technical connection and authority are complete. Genesis can now research the market and establish owner-approved site strategy and creative direction before product or page generation.</p><Link href={`/sites/${encodeURIComponent(site.siteId)}/intelligence`} className="mt-4 inline-block bg-red-600 px-4 py-3 text-sm font-semibold text-white">START SITE INTELLIGENCE</Link></section>
            ...
            <p className="text-xs text-zinc-500">Expert bypass: product authority remains available below, but skipping strategy is an explicit operator choice.</p><div className="grid gap-4 md:grid-cols-2">
