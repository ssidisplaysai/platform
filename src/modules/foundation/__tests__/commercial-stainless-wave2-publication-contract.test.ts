...
describe("Commercial Stainless Wave 2 sequential publication contract", () => {
  test("binds exact owner operation, order, objects, hashes, and homepage baseline", () => {
    for (const marker of ["COMMERCIAL_STAINLESS_WAVE2_OBJECT12_RETRY_AND_RESUME_V2", "bcd1ec3f50bf238cc967d6d58d4e5ca478734492", "commercial-stainless-wave2-object12-retry-and-resume-v2", "[12, 15, 16, 18, 19]", "b2e2f2b690e3d518472bd56e08886701293314d2215838b37d7a3c7fdbf4ddc3", "ac370c9f08aff1b496e16346078d0959ab92d29a4e6a36f57e0dbb54a9bac36c", "ccac7e46d1c40239736c0c65ffe236bd4cbd62e3717cb7ddfd390cf395ef5f4f", "ceb8b68be8125545a71e17f5a6a6ecdb0148f06180555ebaf1e0b389bb9076e2", "5925c0b7c45d0b082f163c9286cb400e5ae47a35045f77cad8239f38d7206c46", "a6bbe8f0db6080c2732cb4baec7bba5d361ebacfc40a16815c655cef8f0e4508"]) expect(publication).toContain(marker);
    expect(route).toContain("previousAuthorityReused: false");
  });
  ...
  test("enforces certified sequence and stop-on-first-failure", () => {
    ...
    expect(route).toContain("RECONCILE_EXACT_COMMERCIAL_STAINLESS_WAVE2_V2_NEXT_OBJECT");
  });
  ...
  test("preserves Wave 1 and exposes only exact scoped commands", () => {
    ...
    expect(route).toContain("CERTIFY_EXACT_COMMERCIAL_STAINLESS_WAVE2_V2_ACTUAL_PUBLIC_RENDER");
