...
export const INTEGRATOR_12596_VISUAL_PLAN = Object.freeze([
  { position: "EASY_MOUNTING", role: "Unistrut mounting detail", referenceId: "integrator-owner-pdf-p3-unistrut", status: "CLEARED", wordpressUploadRequired: true },
  { position: "ALL_WEATHER_PROTECTION", role: "sealed doorway and interior construction", referenceId: "integrator-owner-pdf-p3-sealed-door", status: "CLEARED", wordpressUploadRequired: true },
  { position: "SAFE_AND_SECURE", role: "lock and access detail", referenceId: "integrator-owner-pdf-p3-lock", status: "CLEARED", wordpressUploadRequired: true },
