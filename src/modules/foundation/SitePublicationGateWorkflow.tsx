...
export function SitePublicationGateWorkflow({ mode, site, summary, authorized }: { mode: "READINESS" | "AUTHORIZATION"; site: { organizationId: string; siteId: string }; summary: { drafts: number; designs: number; media: number; navigationItems: number }; authorized?: boolean }) {
