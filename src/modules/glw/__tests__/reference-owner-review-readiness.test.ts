...
describe("GLW reference owner-review readiness", () => {
  test("buyer question form does not authorize embedded factual premises", () => {
    const result = evaluateGlwReferenceOwnerReviewReadiness({ artifact: artifact("<h1>Outdoor Digital Sphere in Indiana</h1><p>Indiana planning.</p><p>What climate conditions matter (humidity, wind, snow, heat)?</p><a href=\"/outdoor-digital-sphere/\">Outdoor Digital Sphere</a>"), media: noMedia, actualHostVisualCertified: false });
  ...
  test("detects mechanical canonicalization prose", () => {
    const result = evaluateGlwReferenceOwnerReviewReadiness({ artifact: artifact("<h1>Outdoor Digital Sphere in Indiana</h1><p>Indiana planning.</p><p>One possible concept a project team could consider is an interactive experience concept.</p><a href=\"/outdoor-digital-sphere/\">Outdoor Digital Sphere</a>"), media: noMedia, actualHostVisualCertified: false });
  ...
  test("requires the complete production composition contract", () => {
    const result = evaluateGlwReferenceOwnerReviewReadiness({ artifact: artifact("<h1>Outdoor Digital Sphere in Indiana</h1><p>Indiana planning.</p><a href=\"/outdoor-digital-sphere/\">Outdoor Digital Sphere</a>"), media: noMedia, actualHostVisualCertified: false });
...
(forensicRoot ? test : test.skip)("owner-rejected object 20115 remains immutable and fails semantic/composition readiness", () => {
  ...
  const result = evaluateGlwReferenceOwnerReviewReadiness({ artifact: job!.generatedDraft, media: noMedia, actualHostVisualCertified: false });
