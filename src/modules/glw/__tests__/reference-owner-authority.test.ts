...
function context(overrides: Partial<Omit<GlwReferenceOwnerContext, "principalId" | "principalSessionId">> = {}) {
  return {
    ...
    productAuthorityFingerprint: "product", claimAuthorityFingerprint: "claim-authority",
    generatorContractFingerprint: "generator-contract", localizationPolicyFingerprint: "localization-policy",
    n8nWorkflowFingerprint: "n8n-workflow", qaPolicyVersion: "qa-v1",
...
describe("GLW reference-generation owner authority", () => {
  ...
  test.each([
    ...
    ["claim authority", principal, { claimAuthorityFingerprint: "wrong" }, "claimAuthorityFingerprint"],
    ["generator contract", principal, { generatorContractFingerprint: "wrong" }, "generatorContractFingerprint"],
    ["localization policy", principal, { localizationPolicyFingerprint: "wrong" }, "localizationPolicyFingerprint"],
    ["n8n workflow", principal, { n8nWorkflowFingerprint: "wrong" }, "n8nWorkflowFingerprint"],
