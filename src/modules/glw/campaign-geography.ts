export type GlwCampaignState = {
  code: string;
  name: string;
  slug: string;
};

export const GLW_CAMPAIGN_US_STATES: readonly GlwCampaignState[] = [
...
export const GLW_CAMPAIGN_ALL_STATE_CODES = GLW_CAMPAIGN_US_STATES.map(
  (state) => state.code,
);
