...
<section class="saw-cta" data-reference-section="CTA"><div class="saw-wrap saw-cta-inner"><p class="saw-kicker">Start the conversation</p><h2>Discuss an Outdoor Digital Sphere project in Indiana</h2><p>Tell us about the intended location, approximate size, application, audience, timeline, and project objectives. We will help organize the next conversation around your project.</p><a class="saw-button saw-button-light" href="/contact-us/">Request Project Information</a></div></section>
  ...
  const css = `:root{color-scheme:light;--saw-ink:#17201d;--saw-muted:#59625d;--saw-line:#dce1dc;--saw-paper:#f7f8f5;--saw-dark:#111816;--saw-accent:#d8402f}*{box-sizing:border-box}.saw-page{width:100%;max-width:none!important;margin:0!important;overflow:clip;background:#fff;color:var(--saw-ink);font-family:"Helvetica Neue",Helvetica,Arial,sans-serif}.saw-page section{position:relative;margin:0!important}.saw-wrap{width:min(1240px,calc(100% - 64px));margin:0 auto}.saw-page h1,.saw-page h2,.saw-page h3{margin:0;letter-spacing:0;color:inherit}.saw-page h1{max-width:850px;font-size:clamp(48px,6vw,86px);line-height:1}.saw-page h2{max-width:760px;font-size:clamp(34px,4vw,56px);line-height:1.08}.saw-page h3{font-size:21px;line-height:1.2}.saw-page p{margin:0;color:var(--saw-muted);font-size:18px;line-height:1.65}.saw-kicker{margin-bottom:18px!important;color:var(--saw-accent)!important;font-size:13px!important;font-weight:800;letter-spacing:1.4px!important;text-transform:uppercase}.saw-hero{min-height:760px;display:flex;align-items:flex-end;isolation:isolate;background:var(--saw-dark)}.saw-hero>img{position:absolute;inset:0;z-index:-2;display:block;width:100%;height:100%;object-fit:cover;object-position:center}.saw-hero-shade{position:absolute;inset:0;z-index:-1;background:linear-gradient(90deg,rgba(8,13,11,.94) 0%,rgba(8,13,11,.72) 48%,rgba(8,13,11,.2) 100%)}.saw-hero-copy{padding:112px 0 86px}.saw-hero h1{color:#fff}.saw-lead{max-width:720px;margin-top:28px!important;color:#e1e6e1!important;font-size:22px!important}.saw-actions{display:flex;gap:14px;flex-wrap:wrap;margin-top:34px}.saw-button{display:inline-flex;min-height:52px;align-items:center;justify-content:center;padding:0 24px;background:var(--saw-accent);color:#fff!important;text-decoration:none!important;font-weight:800}.saw-button-alt{border:1px solid rgba(255,255,255,.75);background:rgba(12,18,15,.3)}.saw-product{padding:104px 0;background:#fff}.saw-split{display:grid;grid-template-columns:minmax(0,1.08fr) minmax(360px,.92fr);gap:72px;align-items:center}.saw-media-frame{min-width:0;overflow:hidden;background:#e7e9e6}.saw-media-frame img{display:block;width:100%;aspect-ratio:4/3;object-fit:cover}.saw-copy h2{margin-bottom:26px}.saw-copy p+p{margin-top:18px}.saw-applications{padding:104px 0;background:var(--saw-paper)}.saw-intro{max-width:680px;margin-top:22px!important}.saw-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:1px;margin-top:48px;background:var(--saw-line);border:1px solid var(--saw-line)}.saw-grid article{min-width:0;padding:34px;background:#fff}.saw-grid span{display:block;margin-bottom:30px;color:var(--saw-accent);font-weight:800}.saw-grid p{margin-top:12px;font-size:16px}.saw-planning{padding:104px 0;background:#fff}.saw-section-heading{display:grid;grid-template-columns:1.2fr .8fr;gap:56px;align-items:end}.saw-section-heading .saw-kicker{grid-column:1/-1}.saw-section-heading p:last-child{padding-bottom:4px}.saw-plan-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:24px;margin-top:54px}.saw-plan-grid>div{min-width:0;padding-top:20px;border-top:3px solid var(--saw-ink)}.saw-plan-grid strong{font-size:18px}.saw-plan-grid p{margin-top:10px;font-size:15px}.saw-cta{padding:104px 0;background:var(--saw-accent);color:#fff}.saw-cta-inner{display:grid;grid-template-columns:1fr auto;gap:28px 64px;align-items:end}.saw-cta .saw-kicker,.saw-cta h2,.saw-cta p{color:#fff!important}.saw-cta .saw-kicker,.saw-cta p{grid-column:1}.saw-cta p{max-width:760px}.saw-cta .saw-button{grid-column:2;grid-row:2/4}.saw-button-light{background:#fff;color:var(--saw-ink)!important}@media(max-width:782px){.saw-wrap{width:min(100% - 40px,1240px)}.saw-page h1{font-size:43px}.saw-page h2{font-size:34px}.saw-page p{font-size:16px}.saw-hero{min-height:650px}.saw-hero-shade{background:linear-gradient(180deg,rgba(8,13,11,.35),rgba(8,13,11,.94) 64%)}.saw-hero-copy{padding:92px 0 52px}.saw-lead{font-size:18px!important}.saw-actions{display:grid}.saw-button{width:100%}.saw-product,.saw-applications,.saw-planning,.saw-cta{padding:68px 0}.saw-split,.saw-section-heading,.saw-cta-inner{grid-template-columns:1fr;gap:34px}.saw-grid{grid-template-columns:1fr}.saw-plan-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.saw-cta .saw-kicker,.saw-cta p,.saw-cta .saw-button{grid-column:1;grid-row:auto}}@media(max-width:420px){.saw-plan-grid{grid-template-columns:1fr}}`;
...
export function candidateVisualSummary(certification: RenderedVisualCertification): { desktopPass: boolean; mobilePass: boolean; horizontalOverflow: number; brokenImages: number; blankImageContainers: number; clippedHeadings: number; headerOverlap: boolean; footerOverlap: boolean; ctaVisible: boolean; mobileReadable: boolean } {
  ...
  const pass = (viewport: typeof desktop) => Boolean(viewport && viewport.horizontalOverflow === 0 && viewport.hero.present && viewport.hero.headingBounds && viewport.hero.primaryCtaBounds && !viewport.hostIntegration.headerOverlap && !viewport.hostIntegration.footerOverlap && viewport.hostIntegration.blankImageContainers === 0 && viewport.media.every((item) => item.rendered));
  ...
  return { desktopPass: pass(desktop), mobilePass: pass(mobile), horizontalOverflow: Math.max(...certification.captures.map((capture) => capture.horizontalOverflow)), brokenImages: certification.captures.reduce((sum, capture) => sum + capture.media.filter((item) => !item.rendered).length, 0), blankImageContainers: certification.captures.reduce((sum, capture) => sum + capture.hostIntegration.blankImageContainers, 0), clippedHeadings: clipped, headerOverlap: certification.captures.some((capture) => capture.hostIntegration.headerOverlap), footerOverlap: certification.captures.some((capture) => capture.hostIntegration.footerOverlap), ctaVisible: certification.captures.every((capture) => Boolean(capture.hero.primaryCtaBounds)), mobileReadable: Boolean(mobile && mobile.primaryContentBounds && mobile.primaryContentBounds.width <= mobile.viewportWidth && mobile.horizontalOverflow === 0) };
}
