...
export async function GET(request: NextRequest, context: { params: Promise<{ campaignId: string }> }) {
  ...
  $("title").text("Outdoor Digital Sphere in Indiana — WordPress draft review"); $("link[rel=canonical]").remove(); $("head").append('<meta name="robots" content="noindex,nofollow"><style>html,body.genesis-rich-page-host{max-width:100%;overflow-x:clip!important}.genesis-rich-page-host>header{position:relative!important;inset:auto!important;width:100%!important;max-width:100%!important;transform:none!important}.genesis-rich-page-host>article{position:relative;z-index:1;width:100%;max-width:100%;margin:0!important;overflow:clip}.genesis-rich-page-host>footer{position:relative!important;clear:both}@media(max-width:782px){.genesis-rich-page-host header .elementor-nav-menu--main{display:none!important}.genesis-rich-page-host header .elementor-nav-menu--dropdown[aria-hidden="true"]{display:none!important;max-width:100%!important}.genesis-rich-page-host header .elementor-menu-toggle{display:flex!important}}</style>'); $("iframe").remove();
