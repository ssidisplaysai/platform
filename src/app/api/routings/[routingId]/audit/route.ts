...
import { getRoutingById, listRoutingAuditEvents } from "@/modules/foundation/routing-repository";
...
export async function GET(request: NextRequest, context: RouteContext) {
  ...
  return NextResponse.json({ auditEvents: listRoutingAuditEvents(routingId) });
}