...
export default async function ProjectPageContentDraftPage({ params }: PageProps) {
  ...
  return <GmpContentWorkspace projectId={id} pageId={pageId} draftId={draftId} mode="draft" />;
}
