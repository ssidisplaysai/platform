...
export default async function ProjectPageContentReviewPage({ params }: PageProps) {
  ...
  return <GmpContentWorkspace projectId={id} pageId={pageId} draftId={draftId} mode="review" />;
}
