...
export default async function SiteBuildPage({ params }: { params: Promise<{ siteId: string }> }) {
  ...
  const showContinuation = ["HOME_DESIGN_REVIEW", "SITE_VISUAL_REVIEW", "SITE_QA", "NAVIGATION_REVIEW", "WORDPRESS_MENU_SYNC", "PUBLICATION_READINESS", "PUBLICATION_AUTHORIZATION"].includes(workspace.stage);
