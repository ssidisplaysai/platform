...
export default async function SiteBuildWordPressReviewPage({ params }: { params: Promise<{ siteId: string }> }) {
  ...
  const showContinuation = ["SITE_QA", "NAVIGATION_REVIEW", "PUBLICATION_READINESS", "PUBLICATION_AUTHORIZATION", "PUBLICATION_EXECUTION_REVIEW", "PUBLICATION_EXECUTING", "PUBLICATION_VERIFICATION", "COMPLETE"].includes(workspace.stage);
