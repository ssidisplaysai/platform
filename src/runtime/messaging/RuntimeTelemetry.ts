import type { RuntimeMessagingMetrics, RuntimeMessagingTelemetrySnapshot } from "./types";
...
export class RuntimeTelemetry {
  ...
  snapshot(metrics: RuntimeMessagingMetrics): RuntimeMessagingTelemetrySnapshot {
    return deepFreeze({
