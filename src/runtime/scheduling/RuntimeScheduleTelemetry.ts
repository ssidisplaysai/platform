import type { RuntimeSchedulingMetrics, RuntimeSchedulingTelemetrySnapshot } from "./types";
...
export class RuntimeScheduleTelemetry {
  ...
  snapshot(metrics: RuntimeSchedulingMetrics): RuntimeSchedulingTelemetrySnapshot {
    return deepFreeze({
