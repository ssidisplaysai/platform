import type { RuntimeWorkflowMetrics, RuntimeWorkflowTelemetrySnapshot } from "./types";
import { deepFreeze } from "./types";

export class RuntimeWorkflowTelemetry {
  ...
  snapshot(metrics: RuntimeWorkflowMetrics): RuntimeWorkflowTelemetrySnapshot {
    return deepFreeze({
