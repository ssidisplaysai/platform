    ...
    async create(data: GlwJobRecord): Promise<GlwJobRecord> {
      const created = await prisma.glwJob.create({
        data: {
          ...
          callbackDeliveryStatus: data.callbackDeliveryStatus,
          terminalReceiptId: data.terminalReceiptId,
    ...
    async update(id: string, changes: Partial<GlwJobRecord>): Promise<GlwJobRecord> {
      const updated = await prisma.glwJob.update({
        ...
        data: {
          ...
          operationKey: changes.operationKey,
          businessStatus: changes.businessStatus,
          callbackDeliveryStatus: changes.callbackDeliveryStatus,
          terminalReceiptId: changes.terminalReceiptId,
          publicationKey: changes.publicationKey,
