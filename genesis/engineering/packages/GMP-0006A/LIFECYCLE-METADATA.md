...
- Package Identifier: GMP-0006A
- Program Identifier: GMP
- Package Title: Scheduling Certification
- Lifecycle State: CERTIFIED
- Status Value: CERTIFIED
- Lifecycle Decision Record: SCHEDULING CERTIFIED
...
- Registry Entry: Genesis-Constitutional-Package-Catalog row for GMP-0006A
...
- Dependencies Reference: GMP-0005A
- Successor Reference: GMP-0007
