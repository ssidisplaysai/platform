...
- Package Identifier: GCP-0002A-R1
- Program Identifier: GCP
- Package Title: Commerce Baseline Regression Alignment
...
- Registry Entry: Genesis-Constitutional-Package-Catalog row for GCP-0002A-R1
...
- Dependencies Reference: GCP-0002A
- Successor Reference: GCP-0002B
