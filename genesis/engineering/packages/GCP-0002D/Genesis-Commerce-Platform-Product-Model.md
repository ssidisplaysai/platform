...
1. Product prompt/SEO/image/brand behaviors are represented through reusable profile references.
2. Product-level profile overrides can supersede inherited site assignments deterministically.
3. Product records continue storing references only; no execution or external integration payloads are embedded.
