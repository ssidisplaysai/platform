...
- Package Identifier: GMP-0003A
- Program Identifier: GMP
- Package Title: Production Job Certification
- Lifecycle State: CERTIFIED
- Status Value: CERTIFIED
- Lifecycle Decision Record: PRODUCTION JOB CERTIFIED
...
- Registry Entry: Genesis-Constitutional-Package-Catalog row for GMP-0003A
...
- Dependencies Reference: GMP-0003
- Successor Reference: GMP-0004A
