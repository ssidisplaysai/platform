...
describe("gba manufacturing authorization", () => {
  it("denies viewer production-order mutation by default policy", () => {
    ...
    const decision = resolver.authorize({
      subject,
      workspaceId: "glw-led-display-warehouse",
      moduleId: "gba.manufacturing",
      action: createActionReference("gba:manufacturing:manage_production_orders", "route_access"),
      resource: {
        workspaceId: "glw-led-display-warehouse",
        moduleId: "gba.manufacturing",
      },
  ...
  it("denies access for subject outside workspace membership", () => {
    ...
    const decision = resolver.authorize({
      ...
      workspaceId: "glw-led-display-warehouse",
      moduleId: "gba.manufacturing",
      action: createActionReference("gba:manufacturing:view_dashboard", "route_access"),
      resource: {
        workspaceId: "glw-led-display-warehouse",
        moduleId: "gba.manufacturing",
      },
