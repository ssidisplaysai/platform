...
describe("gba marketing authorization", () => {
  it("denies viewer campaign mutation by default policy", () => {
    ...
    const decision = resolver.authorize({
      subject,
      workspaceId: "glw-led-display-warehouse",
      moduleId: "gba.marketing",
      action: createActionReference("gba:marketing:manage_campaigns", "route_access"),
      resource: {
        workspaceId: "glw-led-display-warehouse",
        moduleId: "gba.marketing",
      },
  ...
  it("denies access for subject outside workspace membership", () => {
    ...
    const decision = resolver.authorize({
      ...
      workspaceId: "glw-led-display-warehouse",
      moduleId: "gba.marketing",
      action: createActionReference("gba:marketing:view_dashboard", "route_access"),
      resource: {
        workspaceId: "glw-led-display-warehouse",
        moduleId: "gba.marketing",
      },
